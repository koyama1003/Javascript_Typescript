...
const Skillset = () => {
  ...
  const skills = [
    ...
    },
    {
      title: "React",
      detail:
        "APIモードのRailsと非同期通信しデータを取得するSPA的動作のtodoアプリを作成できる",
      icon: faReact,
    },
    {
      title: "Redux",
      detail: "Redux-Thunkを用いてAPIからデータを取得するアプリを作成できる",
    ...
    },
    {
      title: "Docker",
      detail:
        "Dockerfileやdocker-compose.ymlを理解し、docker composeコマンドにてECS Deployができる",
      icon: faDocker,
    },
    {
      title: "Travis CI",
